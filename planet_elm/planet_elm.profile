...
function planet_elm_install_tasks() {
  ...
  $tasks['planet_elm_setup_og_permissions'] = array(
    'display_name' => st('Set Blocks'),
    'display' => FALSE,
  );

  // Run this as the last task!
  $tasks['planet_elm_setup_rebuild_permissions'] = array(
...
function planet_elm_setup_variables() {
  $variables = array(
    ...
    'features_default_export_path' => 'profiles/planet_elm/modules/custom',
    // Mime-mail.
    'mimemail_format' => 'full_html',
    'mimemail_sitestyle' => FALSE,
    'mimemail_name' => 'PlanetElm',
    'mimemail_mail' => 'info@planet_elm.com',
    // jQuery versions.
 ...
 * created.
 */
function planet_elm_setup_og_permissions() {
 ...
 */
function planet_elm_setup_blocks() {
 ...
 * installation.
 */
function planet_elm_setup_rebuild_permissions() {
  node_access_rebuild();
}
