[![Build Status](https://travis-ci.org/Gizra/planet-elm.svg)](https://travis-ci.org/Gizra/planet-elm)

# Drupal 7 - Install Profile PlanetElm
...
Clone the project from [GitHub](https://github.com/Gizra/planet_elm).
...
6. Makes a symlink within the /www/profiles directory to the /planet_elm
   directory.
7. Run the Drupal installer (Drush) using the PlanetElm profile.
